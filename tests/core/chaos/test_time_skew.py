...
def test_time_skew_streaming(
    ...
    """
    has_chaos_metadata = any("time_skew" in str(op) for op in chaos_applied)
...
def test_time_skew_rest(
    baseline_items: list[Dict[str, Any]],
    chaos_items: list[Dict[str, Any]],
    chaos_applied: list[str],
) -> tuple[bool, Dict[str, Any]]:
    """Test time_skew for REST endpoint."""
    return test_time_skew_streaming(baseline_items, chaos_items, chaos_applied)
